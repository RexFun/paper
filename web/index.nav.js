...
//    },
    ...
    */
    getDom:function(k,a){
        ...
        html += "<li class=\"active\" menuId=\"0\"><a href=\""+$ctx+"/index.jsp?menuId=0\"><i class=\"fa fa-home\"></i><span>首页</span></a>";
        	...
        	if(this.groups[a[i].id] && this.groups[a[i].id].length > 0){ // 有子节点
        		if(a[i].pid == 0){// 1级菜单
        			if(a[i].tc_url == "")
						...
						html += "<li class=\"treeview\" menuId=\""+a[i].id+"\"><a href=\""+$ctx+""+a[i].tc_url+"?menuId="+a[i].id+"&menuPermitId="+a[i].tc_sys_permit_id+"\"><i class=\"fa fa-cog\"></i><span>"+a[i].tc_name+"</span><span class=\"pull-right-container\"><i class=\"fa fa-angle-left pull-right\"></i></span></a>";
        		}else{// 非1级菜单
        			if(a[i].tc_url == "")
						...
						html += "<li class=\"treeview\" menuId=\""+a[i].id+"\"><a href=\""+$ctx+""+a[i].tc_url+"?menuId="+a[i].id+"&menuPermitId="+a[i].tc_sys_permit_id+"\"><i class=\"fa fa-circle-o\"></i><span>"+a[i].tc_name+"</span><span class=\"pull-right-container\"><i class=\"fa fa-angle-left pull-right\"></i></span></a>";
        		}
        	}else{// 没有子节点
        		if(a[i].pid == 0){// 1级菜单
        			if(a[i].tc_url == "")
        				...
        				html += "<li menuId=\""+a[i].id+"\"\><a href=\""+$ctx+""+a[i].tc_url+"?menuId="+a[i].id+"&menuPermitId="+a[i].tc_sys_permit_id+"\"><i class=\"fa fa-list\"></i><span>"+a[i].tc_name+"</span></a>";
        		}else{ // 非1级菜单
        			if(a[i].tc_url == "")
        				html += "<li menuId=\""+a[i].id+"\"><a href=\"javascript:void(0)\"><i class=\"fa fa-circle-o\"></i><span>"+a[i].tc_name+"</span></a>";
       				else
        				html += "<li menuId=\""+a[i].id+"\"><a href=\""+$ctx+""+a[i].tc_url+"?menuId="+a[i].id+"&menuPermitId="+a[i].tc_sys_permit_id+"\"><i class=\"fa fa-circle-o\"></i><span>"+a[i].tc_name+"</span></a>";
        		}
        	}
